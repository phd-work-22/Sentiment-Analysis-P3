...
write.csv(median_negs, 
          "<file_path>2019-2023_Median_values_GRAINS.csv", 
          row.names=TRUE)
################################################################################
...
write.csv(median_dwns, 
          "<file_path>2019-2023_Median_DWNS_values_GRAINS.csv", 
          row.names=TRUE)
################################################################################
...
write.csv(median_pos, 
          "<file_path>2019-2023_Median_POSvalues_GRAINS.csv", 
          row.names=TRUE)
################################################################################
...
write.csv(median_dwps, 
          "<file_path>2019-2023_Median_DWPS_values_GRAINS.csv", 
          row.names=TRUE)
