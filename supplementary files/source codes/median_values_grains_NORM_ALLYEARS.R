...
df_devops <- read.csv("normalised_developers-by-grains.csv",TRUE,',')
df_devops <- subset(df_devops, select = c('path', 'year', 'variable', 'norm'))
df_dataSentences <- read.csv("normalised_data-new-by-grains.csv",TRUE,',')
...
write.csv(median_negs, 
          "/Volumes/Data/PhD/Gentoo/CSV Files/median/2019-2023_Median_values_GRAINS.csv", 
          row.names=TRUE)
################################################################################
...
write.csv(median_dwns, 
          "/Volumes/Data/PhD/Gentoo/CSV Files/median/2019-2023_Median_DWNS_values_GRAINS.csv", 
          row.names=TRUE)
################################################################################
...
write.csv(median_pos, 
          "/Volumes/Data/PhD/Gentoo/CSV Files/median/2019-2023_Median_POSvalues_GRAINS.csv", 
          row.names=TRUE)
################################################################################
...
write.csv(median_dwps, 
          "/Volumes/Data/PhD/Gentoo/CSV Files/median/2019-2023_Median_DWPS_values_GRAINS.csv", 
          row.names=TRUE)
